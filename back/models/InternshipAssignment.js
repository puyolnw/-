...
class InternshipAssignment {
  ...
  static async apply(studentId, schoolId, academicYearId, teacherId = null) {
    try {
      console.log('🔵 Backend - InternshipAssignment.apply called with:', { studentId, schoolId, academicYearId, teacherId });
      ...
      const [result] = await pool.execute(
        `INSERT INTO internship_assignments (student_id, school_id, academic_year_id, teacher_id, status) 
         VALUES (?, ?, ?, ?, 'active')`,
        [studentId, schoolId, academicYearId, teacherId]
      );
