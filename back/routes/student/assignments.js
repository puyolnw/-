...
// GET /api/student/assignments/school-teachers - ดึงรายการครูพี่เลี้ยงของโรงเรียน
router.get('/school-teachers',
  query('school_id').notEmpty().withMessage('School ID is required'),
  query('academic_year_id').isInt({ min: 1 }).withMessage('Academic year ID must be positive integer'),
  handleValidationErrors,
  getSchoolTeachers
);
