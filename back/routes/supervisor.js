...
// การประเมินคำร้องขอสำเร็จการฝึกแบบละเอียด (เหมือนครูพี่เลี้ยง)
router.put('/completion-requests/:requestId/evaluate', supervisorController.evaluateCompletionRequest);

// ข้อมูลแผนการสอนและบันทึกการฝึกประสบการณ์ทั้งหมดในระบบ
router.get('/lesson-plans', supervisorController.getAllLessonPlans);
router.get('/teaching-sessions', supervisorController.getAllTeachingSessions);
