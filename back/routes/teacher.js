...
// New routes for viewing all students data
router.get('/lesson-plans', getAllStudentsLessonPlans);
router.get('/teaching-sessions', getAllStudentsTeachingSessions);

// File download routes
router.get('/lesson-plans/:planId/files/:fileId', downloadLessonPlanFile);
