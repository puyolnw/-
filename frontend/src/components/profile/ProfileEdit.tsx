        ...
        {activeTab === 'profile' && (
          <form onSubmit={handleProfileSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* รหัสโรงเรียน - ซ่อนสำหรับทุก role ตามความต้องการใหม่ */}
              {false && (
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      required={!user?.student_code} // required เฉพาะถ้ายังไม่มีข้อมูล
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      required={!user?.faculty} // required เฉพาะถ้ายังไม่มีข้อมูล
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      required={!user?.major} // required เฉพาะถ้ายังไม่มีข้อมูล
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 ${
