...
type SortField = 'school_name' | 'school_id' | 'created_at';
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-gray-900">รายการโรงเรียน</h3>
          <span className="text-sm text-gray-500">
            แสดง {startIndex + 1}-{Math.min(endIndex, sortedSchools.length)} จาก {sortedSchools.length} รายการ
          </span>
        </div>
      </div>
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                ...
                <span className="font-medium">{Math.min(endIndex, sortedSchools.length)}</span> จาก{' '}
                <span className="font-medium">{sortedSchools.length}</span> รายการ
              </p>
            </div>
            <div>
