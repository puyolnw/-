          ...
          <div key={request.id} className="bg-white shadow rounded-lg p-6">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-700 bg-gray-50 p-3 rounded-md">
                {request.self_evaluation && request.self_evaluation.trim() !== '' 
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-500 mb-2">ผลงานที่ภาคภูมิใจ</p>
              <p className="text-sm text-gray-700 bg-gray-50 p-3 rounded-md">
                {request.achievements && request.achievements.trim() !== '' 
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-500 mb-2">ความท้าทายที่เผชิญ</p>
              <p className="text-sm text-gray-700 bg-gray-50 p-3 rounded-md">
                {request.challenges_faced && request.challenges_faced.trim() !== '' 
                  ? request.challenges_faced 
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-500 mb-2">ทักษะที่พัฒนาได้</p>
              <p className="text-sm text-gray-700 bg-gray-50 p-3 rounded-md">
                {request.skills_developed && request.skills_developed.trim() !== '' 
                  ? request.skills_developed 
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-500 mb-2">เป้าหมายในอนาคต</p>
              <p className="text-sm text-gray-700 bg-gray-50 p-3 rounded-md">
                {request.future_goals && request.future_goals.trim() !== '' 
                  ? request.future_goals 
