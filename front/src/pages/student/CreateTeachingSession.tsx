  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await teachingSessionApiService.createTeachingSession({
        ...
        learning_activities: learningActivities || null,
        learning_outcomes: learningOutcomes || null,
        teaching_methods_used: null,
        materials_used: null,
        student_engagement: null,
        problems_encountered: problemsEncountered || null,
        problem_solutions: problemSolutions || null,
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="กิจกรรมการเรียนรู้ที่จัดให้นักเรียนในคาบนี้"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="ข้อเสนอแนะและแนวทางแก้ไขปัญหาที่เกิดขึ้น"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
