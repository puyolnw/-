...
class TeacherApiService {
  ...
  async evaluateCompletionRequest(requestId: number, comments: string, rating: number, status: string, detailedEvaluationData?: any[]): Promise<{ success: boolean; message?: string }> {
    try {
      console.log('🔵 Frontend - Evaluating completion request:', { requestId, comments, rating, status, detailedEvaluationData });
